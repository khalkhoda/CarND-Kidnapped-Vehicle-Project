...
class ParticleFilter {
 ...
 private:
  ...
  double calculate_weight(const std::vector<LandmarkObs>& predicted,
                          const std::vector<LandmarkObs>& observations,
                          double std_landmark[]);

  void transformObss(std::vector<LandmarkObs> const &observations,
                     Particle const &p,
                     std::vector <LandmarkObs> &transObss);

  void predictObss(const Map &map_landmarks,
                   double sensor_range,
                   Particle const &p,
                   std::vector<LandmarkObs> &predObss);
};
